import {
  useButton
} from "./chunk-4ZVXCKHX.js";
import {
  generateUtilityClass,
  generateUtilityClasses,
  useFormControlContext,
  useInput
} from "./chunk-XZJAPBL3.js";
import {
  require_react_dom
...
function useControllableReducer(parameters) {
  ...
  const controlledPropsRef = React5.useRef(controlledProps);
  if (true) {
    React5.useEffect(() => {
      Object.keys(controlledProps).forEach((key) => {
...
function useDropdown(parameters = {}) {
  ...
  const [popupId, setPopupId] = React6.useState("");
  const [triggerElement, setTriggerElement] = React6.useState(null);
  const lastActionType = React6.useRef(null);
  const handleStateChange = React6.useCallback((event, field, value, reason) => {
    if (field === "open") {
      onOpenChange == null || onOpenChange(event, value);
    }
    lastActionType.current = reason;
  }, [onOpenChange]);
  const controlledProps = React6.useMemo(() => openProp !== void 0 ? {
    open: openProp
  } : {}, [openProp]);
...
var Input = React9.forwardRef(function Input2(props, forwardedRef) {
...
function useList(params) {
  ...
  const handleHighlightChange = React11.useCallback((event, value, reason) => {
  ...
  const stateComparers = React11.useMemo(() => ({
    highlightedValue: itemComparer,
    selectedValues: (valuesArray1, valuesArray2) => areArraysEqual(valuesArray1, valuesArray2, itemComparer)
  }), [itemComparer]);
  const handleStateChange = React11.useCallback((event, field, value, reason, state2) => {
  ...
  const listActionContext = React11.useMemo(() => {
    return {
      disabledItemsFocusable,
      disableListWrap,
      focusManagement,
  ...
  const actionContext = React11.useMemo(() => _extends({}, reducerActionContext, listActionContext), [reducerActionContext, listActionContext]);
  const [state, dispatch] = useControllableReducer({
    reducer,
    actionContext,
    initialState,
  ...
  const previousItems = React11.useRef([]);
  React11.useEffect(() => {
  ...
  const getItemState = React11.useCallback((item) => {
...
var ListContext = React12.createContext(null);
if (true) {
...
function useListItem(parameters) {
  ...
  const listContext = React13.useContext(ListContext);
  if (!listContext) {
  ...
  const createHandleClick = React13.useCallback((externalHandlers) => (event) => {
  ...
  const createHandlePointerOver = React13.useCallback((externalHandlers) => (event) => {
...
var CompoundComponentContext = React14.createContext(null);
if (true) {
...
function useCompoundParent() {
  const [subitems, setSubitems] = React14.useState(/* @__PURE__ */ new Map());
  const subitemKeys = React14.useRef(/* @__PURE__ */ new Set());
  const deregisterItem = React14.useCallback(function deregisterItem2(id) {
  ...
  const registerItem = React14.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React14.useMemo(() => sortSubitems(subitems), [subitems]);
  const getItemIndex = React14.useCallback(function getItemIndex2(id) {
...
function useCompoundItem(id, itemMetadata) {
  const context = React15.useContext(CompoundComponentContext);
  if (context === null) {
  ...
  const [registeredId, setRegisteredId] = React15.useState(typeof id === "function" ? void 0 : id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React16.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  const isInitiallyOpen = React16.useRef(open);
  const {
    subitems,
  ...
  const reducerActionContext = React16.useMemo(() => ({
    listboxRef: rootRef
  }), [rootRef]);
  const {
...
function MenuProvider(props) {
  ...
  const listContextValue = React17.useMemo(() => ({
    dispatch,
    getItemState,
    getItemIndex
  }), [dispatch, getItemIndex, getItemState]);
  const compoundComponentContextValue = React17.useMemo(() => ({
    getItemIndex,
    registerItem,
    totalSubitemCount
...
var Portal = React19.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime11.jsx)(React19.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime11.jsx)(React19.Fragment, {
...
var TransitionContext = React20.createContext(null);
if (true) {
...
function useTransitionStateManager() {
  const transitionContext = React21.useContext(TransitionContext);
...
function useTransitionTrigger(requestEnter) {
  const [exitTransitionFinished, setExitTransitionFinished] = React22.useState(true);
  const hasPendingExitTransition = React22.useRef(false);
  const registeredTransitions = React22.useRef(0);
  const [hasTransition, setHasTransition] = React22.useState(false);
  const previousRequestEnter = React22.useRef(requestEnter);
  React22.useEffect(() => {
  ...
  const handleExited = React22.useCallback(() => {
    hasPendingExitTransition.current = false;
    setExitTransitionFinished(true);
  }, []);
  const registerTransition = React22.useCallback(() => {
...
var PopupContext = React23.createContext(null);
if (true) {
...
var Popup = React24.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children,
  ...
  const popupContextValue = React24.useMemo(() => ({
    placement: finalPlacement
  }), [finalPlacement]);
...
var Menu = React25.forwardRef(function Menu2(props, forwardedRef) {
...
function useMenuButton(parameters = {}) {
  ...
  const menuContext = React26.useContext(DropdownContext);
  if (menuContext === null) {
...
var MenuButton = React27.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    slots = {},
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = (_React$useContext = React28.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
var InnerMenuItem = React30.memo(React30.forwardRef(function MenuItem(props, forwardedRef) {
  var _slots$root;
  const {
    children,
...
var MenuItem2 = React30.forwardRef(function MenuItem3(props, ref) {
  const {
    id: idProp
  } = props;
  const {
...
var Modal = React32.forwardRef(function Modal2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    closeAfterTransition = false,
...
function NoSsr(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(React33.Fragment, {
...
function useNumberInput(parameters) {
  ...
  const handleStateChange = React34.useCallback((event, field, fieldValue, reason) => {
  ...
  const numberInputActionContext = React34.useMemo(() => {
    return {
      min: min3,
      max: max3,
      step,
  ...
  const controlledState = React34.useMemo(() => ({
    value: valueProp
  }), [valueProp]);
  const [state, dispatch] = useControllableReducer({
    ...
    initialState,
    onStateChange: handleStateChange,
    actionContext: React34.useMemo(() => numberInputActionContext, [numberInputActionContext]),
    componentName
  });
  const {
    value,
...
var NumberInput = React35.forwardRef(function NumberInput2(props, forwardedRef) {
...
function useOptionContextStabilizer(value) {
  ...
  const localGetItemState = React38.useCallback((itemValue) => {
    if (itemValue !== value) {
  ...
  const localContextValue = React38.useMemo(() => ({
    dispatch,
    getItemState: localGetItemState
  }), [dispatch, localGetItemState]);
  return {
...
var InnerOption = React39.memo(React39.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React39.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
var PopperTooltip = React40.forwardRef(function PopperTooltip2(props, forwardedRef) {
  var _slots$root;
  const {
    anchorEl,
    children,
  ...
  const [resolvedAnchorElement, setResolvedAnchorElement] = React40.useState(resolveAnchorEl(anchorEl));
  React40.useEffect(() => {
...
var Popper = React40.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
...
function defaultRenderValue(selectedOptions) {
  ...
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime26.jsx)(React43.Fragment, {
...
var Select = React43.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime27.jsxs)(React43.Fragment, {
...
var Slider = React45.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime29.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime28.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime28.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime29.jsxs)(React45.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EX75IP2K.js.map
